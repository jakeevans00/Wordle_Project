...
"""
ITALIAN_WORDS = [
    'abbia', 'abile', 'abiti', 'abito', 'about', 'abusi', 'abuso', 'acciò', 'acidi', 'acido',
    'acqua', 'acque', 'acuta', 'acute', 'acuto', 'Adamo', 'Adige', 'aerea', 'aerei', 'aereo',
    'after', 'agire', 'agito', 'ainsi', 'aiuta', 'aiuti', 'aiuto', 'alcun', 'aliis', 'altra',
    'altre', 'altri', 'altro', 'amare', 'amata', 'amato', 'amava', 'amica', 'amici', 'amico',
    'amore', 'amori', 'ampia', 'ampie', 'ampio', 'anche', 'ancor', 'andar', 'andrà', 'anglo',
    'anima', 'anime', 'animi', 'animo', 'annua', 'annuo', 'ansia', 'Aosta', 'après', 'arabi',
    'arabo', 'archi', 'asilo', 'assai', 'Atene', 'atomi', 'atque', 'attua', 'aussi',
    'autem', 'autre', 'avait', 'avere', 'avete', 'aveva', 'avevo', 'avoir', 'avrei', 'avuta',
    'avuti', 'avuto', 'avvio', 'azoto', 'bacio', 'bagno', 'Balbo', 'ballo', 'Banca', 'banco',
    'banda', 'bande', 'bando', 'barba', 'barca', 'bassa', 'basse', 'bassi', 'basso', 'basta',
    'basti', 'bella', 'belle', 'belli', 'bello', 'bensì', 'bocca', 'Boll.', 'bolla', 'bollo',
    'bombe', 'bontà', 'bordo', 'Borgo', 'borsa', 'bosco', 'brani', 'brano', 'bravo', 'breve',
    'brevi', 'Bruno', 'buona', 'buone', 'buoni', 'buono', 'busta', 'busto', 'cadde', 'caffè',
    'calce', 'calda', 'caldo', 'calma', 'cambi', 'campi', 'campo', 'canta', 'canti', 'canto',
    'Capua', 'Carlo', 'carne', 'carni', 'carri', 'carro', 'carta', 'carte', 'Cassa',
    'casse', 'causa', 'cause', 'cella', 'celle', 'celui', 'cenni', 'cenno', 'cento', "c'era",
    'cerca', 'cercò', 'certa', 'certe', 'certi', 'certo', 'cessa', 'cette', "ch'io",
    'cicli', 'ciclo', 'cieca', 'cieco', 'cieli', 'cielo', 'cifra', 'cifre', 'cinta', 'circa',
    'città', 'clero', 'clima', 'cogli', 'colla', 'colle', 'colli', 'collo', 'color', 'colpa',
    'colpe', 'colpi', 'colpo', 'colta', 'colto', 'colui', "com'è", 'Comm.', 'comma', 'comme',
    'commi', 'conf.', 'conta', 'conte', 'conti', 'conto', 'copia', 'copie', 'copre', 'corda',
    'corde', 'corpi', 'corpo', 'corre', 'corsa', 'corse', 'corsi', 'corso', 'Corte', 'corti',
    'corto', "cos'è", 'costa', 'coste', 'costi', 'costo', 'creda', 'crede', 'credo',
    'crisi', 'Croce', 'culti', 'culto', 'Cuneo', 'cuore', 'cuori', 'Curia', 'curva', 'curve',
    'dagli', 'dalla', 'dalle', 'dallo', 'dando', 'danni', 'danno', 'Dante', 'danza', 'darne',
    'darsi', 'David', 'dazio', 'debba', 'debbo', 'degli', 'degna', 'degne', 'degni', 'degno',
    'delia', "dell'", 'della', 'delle', 'delli', 'dello', 'dente', 'denti', 'desse', 'detta',
    'dette', 'detti', 'detto', 'dicti', 'dicto', 'dieci', 'diede', 'Diego', 'dieta', 'direi',
    'dirlo', 'dirsi', 'disco', 'disse', 'dissi', 'ditta', 'dogma', 'dolce', 'dolci', 'dovea',
    'dover', 'dovrà', 'droit', 'dubbi', 'Duomo', 'ebrei', 'ebreo', 'edito', 'einer', 'Elena',
    'entra', 'entre', 'entro', 'entrò', 'eorum', 'epoca', 'erano', 'erasi', 'erede', 'eredi',
    'esame', 'esami', 'esige', 'esiti', 'esito', 'esser', 'était', 'etere', 'etiam', 'etica',
    'etico', 'extra', 'Fabio', 'facce', 'facto', 'faire', 'fallo', 'falsa', 'FALSE', 'falsi',
    'falso', 'fango', 'fanno', 'fanti', 'farci', 'farla', 'farle', 'farli', 'farlo', 'farmi',
    'farne', 'farsi', 'farvi', 'fasce', 'fasci', 'fatta', 'fatte', 'fatti', 'fatto', 'ferma',
    'fermi', 'fermo', 'Ferri', 'ferro', 'festa', 'feste', 'feudo', 'fiato', 'fibre', 'fiera',
    'fieri', 'figli', 'fiore', 'fiori', 'firma', 'first', 'fissa', 'fisse', 'fissi', 'fisso',
    'fitta', 'fitto', 'fiume', 'fiumi', 'fogli', 'folla', 'folle', 'fonda', 'fondi', 'fondo',
    'fonte', 'fonti', 'Forlì', 'forma', 'forme', 'forno', 'forse', 'forte', 'forti', 'forza',
    'forze', 'fossa', 'fosse', 'fossi', 'frase', 'frasi', 'frate', 'frati', 'freno', 'Freud',
    'frode', 'fuoco', 'fuori', 'furia', 'furon', 'furto', 'fusse', 'Gaeta', 'Galli', 'Gallo',
    'gamba', 'gambe', 'gamma', 'genio', 'gente', 'genti', 'germe', 'germi', 'gesti', 'gesto',
    'getto', 'gioco', 'gioia', 'giova', 'Giove', 'Giust', 'globo', 'golfo', 'gomma', 'gradi',
    'grado', 'grand', 'grani', 'grano', 'grato', 'grave', 'gravi', 'greca', 'greci', 'greco',
    'grida', 'grido', 'guida', 'Guido', 'guisa', 'gusti', 'gusto', 'hanno', 'Hegel', 'Henry',
    'homme', 'Iddio', 'India', 'infra', 'inizi', 'inter', 'invio', 'ipsum', 'isola', 'isole',
    'italo', 'Italy', 'iuris', 'James', 'laghi', 'laica', 'laici', 'laico', 'larg', 'larva',
    'lasci', 'latte', 'Laura', 'Lazio', 'Lecce', 'legge', 'leggi', 'leghe', 'legno', 'lembo',
    'Lenin', 'lenta', 'lente', 'lenti', 'lento', 'Leone', 'letta', 'letti', 'letto', 'leurs',
    'Liber', 'Libia', 'libri', 'libro', 'lieto', 'lieve', 'lievi', 'linea', 'linee', 'Lione',
    'lista', 'liste', 'Livio', 'lordo', 'lotta', 'lotte', 'Louis', 'Lucca', 'Lucia', 'Lucio',
    'Luigi', 'Luisa', 'lunga', 'lungi', 'lungo', 'luogo', 'lusso', 'lutto', 'madre', 'madri',
    'mafia', 'magia', 'Magno', 'Malta', 'mamma', 'manca', 'mancò', 'manda', 'mandò', 'marca',
    'Marco', 'Maria', 'Marie', 'Mario', 'marmi', 'marmo', 'marzo', 'Mass.', 'massa', 'masse',
    'Mauro', 'media', 'medie', 'medio', 'mensa', 'mente', 'menti', 'mento', 'merce', 'mercè',
    'merci', 'messa', 'messe', 'messi', 'messo', 'metri', 'metro', 'mette', 'mezza', 'mezzi',
    'mezzo', 'miele', 'mille', 'minor', 'mista', 'misto', 'moins', 'molle', 'molli', 'molta',
    'molte', 'molti', 'molto', 'monde', 'mondi', 'mondo', 'Mons.', 'Monte', 'monti', 'Monza',
    'morbo', 'morta', 'morte', 'morti', 'morto', 'Mosca', 'mossa', 'mosse', 'mosso', 'motto',
    'multa', 'muore', 'muove', 'musei', 'Museo', 'mutuo', 'narra', 'nasce', 'negli', 'Negri',
    'nella', 'nelle', 'nello', 'nervi', 'nervo', 'nesso', 'netta', 'netto', 'nicht',
    'niuno', 'Nizza', 'nobis', 'nonna', 'nonno', 'norma', 'norme', 'notai', 'notre', 'notte',
    'notti', 'nozze', 'nulla', 'nullo', 'nuova', 'nuove', 'nuovi', 'nuovo', 'occhi', 'odore',
    'offre', 'oltre', 'ombra', 'ombre', 'Omero', 'omnes', 'omnia', 'onere', 'oneri', 'onore',
    'onori', 'opera', 'opere', 'orale', 'ormai', 'ossia', 'other', 'ovest', 'ovvio', 'padre',
    'padri', 'paese', 'paesi', 'palla', 'panni', 'Paola', 'Paolo', 'parco', 'Paris', 'parla',
    'parli', 'parlo', 'parlò', 'Parma', 'parmi', 'parso', 'parte', 'parti', 'partì', 'parto',
    'parve', 'passa', 'passi', 'passo', 'passò', 'pasta', 'patti', 'patto', 'paura', 'Pavia',
    'pegno', 'pelle', 'penna', 'pensa', 'pensi', 'penso', 'pensò', 'perde', 'perso', 'pesca',
    'pesce', 'pesci', 'peste', 'Peter', 'petto', 'pezzi', 'pezzo', 'piace', 'piana', 'piani',
    'piano', 'piede', 'piedi', 'piega', 'piena', 'piene', 'pieni', 'pieno', 'Piero', 'pietà',
    'place', 'plebe', 'poche', 'pochi', 'poema', 'poeta', 'poeti', 'point', 'polso', 'pompa',
    'ponte', 'ponti', 'porre', 'porsi', 'porta', 'porte', 'porti', 'porto', 'portò', 'possa',
    'posso', 'posta', 'poste', 'posti', 'posto', 'poter', 'potrà', 'pozzo', 'Praga', 'prati',
    'Prato', 'preda', 'pregi', 'prego', 'preme', 'premi', 'Pres.', 'presa', 'prese', 'presi',
    'preso', 'Press', 'presu', 'prete', 'preti', 'prima', 'prime', 'primi', 'primo', 'priva',
    'prive', 'privi', 'privo', 'Prof.', 'prole', 'prosa', 'prova', 'prove', 'pugno', 'punta',
    'punte', 'punti', 'punto', 'quale', 'quali', 'quasi', 'quell', 'quest', 'quivi',
    'quota', 'quote', 'radio', 'raggi', 'rango', 'ratio', 'razza', 'razze', 'reale',
    'reali', 'reati', 'reato', 'regge', 'regia', 'regio', 'regni', 'regno', 'Reich', 'renda',
    'rende', 'Renzo', 'rerum', 'resta', 'resti', 'resto', 'restò', 'retro', 'retta', 'rette',
    'retto', 'Revue', 'ricca', 'Ricci', 'ricco', 'righe', 'ritmi', 'ritmo', 'Rocca', 'rocce',
    'Rocco', 'Roman', 'rossa', 'rosse', 'Rossi', 'rosso', 'rotta', 'rotto', 'ruoli', 'ruolo',
    'ruota', 'ruote', 'russa', 'russi', 'russo', 'sacco', 'sacra', 'sacre', 'sacri', 'sacro',
    'saggi', 'Saint', 'saldo', 'salto', 'salva', 'salvo', 'sanno', 'Santa', 'santi', 'Santo',
    'saper', 'sardo', 'sarei', 'scala', 'scale', 'scavi', 'scavo', 'scena', 'scene', 'scopi',
    'scopo', 'scudi', 'scudo', 'scuro', 'scusa', 'secca', 'secco', 'sedia', 'segna', 'segni',
    'segno', 'segue', 'seguì', 'senno', 'sensi', 'senso', 'sente', 'senti', 'sentì', 'sento',
    'senza', 'seppe', "s'era", 'seria', 'serie', 'serio', 'Serra', 'serva', 'serve', 'servi',
    'servo', 'sessi', 'sesso', 'sesto', 'setta', 'sette', 'sfera', 'sfere', 'sfida', 'siamo',
    'siano', 'siasi', 'sicut', 'siede', 'Siena', 'sieno', 'siero', 'siete', 'Simon', 'Siria',
    'Sisto', 'Smith', 'socio', 'sodio', 'Sofia', 'sogni', 'sogno', 'solco', 'soldi', 'soldo',
    'somma', 'somme', 'sommo', 'sonno', 'sopra', 'sorge', 'sorta', 'sorte', 'sorti', 'sorto',
    'sosta', 'sotto', 'sovra', 'spada', 'spazi', 'spera', 'spero', 'spesa', 'spese', 'sport',
    'sposa', 'sposi', 'sposo', 'stadi', 'stare', 'stata', 'state', 'stati', 'stato', 'stava',
    'stile', 'stili', 'stima', 'studi', 'study', 'sugli', 'sulla', 'sulle', 'sullo', 'suole',
    'suolo', 'suona', 'suoni', 'suono', 'super', 'supra', 'tagli', 'tamen', 'tanta', 'tante',
    'tanti', 'tanto', 'tappa', 'tappe', 'tarda', 'tardi', 'tardo', 'tasca', 'tassa', 'tasse',
    'tassi', 'tasso', 'tempi', 'tempo', 'temps', 'tenda', 'tende', 'tener', 'tenga', 'tenne',
    'tenta', 'tentò', 'tenue', 'terra', 'terre', 'terza', 'terzi', 'terzo', 'testa', 'teste',
    'testi', 'testo', 'tetto', 'their', 'there', 'these', 'those', 'tiene', 'tinte', 'tocca',
    'tolta', 'tolto', 'tomba', 'tombe', 'torna', 'tornò', 'torre', 'torri', 'torto', 'tosto',
    'toute', 'trama', 'treno', 'Trib.', 'tribù', 'trono', 'trova', 'trovi', 'trovo', 'trovò',
    'turco', 'turno', 'tutta', 'tutte', 'tutti', 'tutto', 'Udine', 'udire', 'udire', 'udito',
    'ultra', 'umana', 'umane', 'umani', 'umano', 'umile', 'umili', 'umore', 'under', 'unica',
    'unici', 'unico', 'unita', 'unità', 'unite', 'Uniti', 'unito', 'Univ.', 'usano', 'usare',
    'usata', 'usate', 'usati', 'usato', 'usque', 'utile', 'utili', 'valga', 'valle', 'valli',
    'vanno', 'varia', 'varie', 'varii', 'vario', 'vasta', 'vaste', 'vasti', 'vasto', 'veder',
    'vedrà', 'venga', 'venir', 'venne', 'venti', 'vento', 'verbo', 'verde', 'Verdi', 'Verga',
    'verrà', 'versi', 'verso', 'veste', 'vesti', 'vetri', 'vetro', 'video', 'viene', 'vieta',
    'villa', 'ville', 'vinti', 'vinto', 'viola', 'virtù', 'virus', 'visse', 'vista', 'viste',
    'visti', 'visto', 'vizio', 'voler', 'volge', 'volle', 'volta', 'volte', 'volti', 'volto',
    'vorra',
]
